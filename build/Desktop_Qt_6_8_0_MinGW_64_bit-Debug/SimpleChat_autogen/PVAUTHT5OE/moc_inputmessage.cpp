...
#include "../../../../ChatForm/ChatContent/inputmessage.h"
...
struct qt_meta_stringdata_CLASSInputMessageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSInputMessageENDCLASS = QtMocHelpers::stringData(
    "InputMessage",
    "adjustHeight",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSInputMessageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject InputMessage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSInputMessageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSInputMessageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSInputMessageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *InputMessage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSInputMessageENDCLASS.stringdata0))
