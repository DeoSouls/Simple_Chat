...
#include "../../../../ChatForm/switchchatcontainer.h"
...
struct qt_meta_stringdata_CLASSSwitchChatContainerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSwitchChatContainerENDCLASS = QtMocHelpers::stringData(
    "SwitchChatContainer",
    "showChat",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSwitchChatContainerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SwitchChatContainer::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSwitchChatContainerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSwitchChatContainerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSwitchChatContainerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *SwitchChatContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSwitchChatContainerENDCLASS.stringdata0))
