...
namespace {
struct qt_meta_tag_ZN11LoginButtonE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11LoginButtonE = QtMocHelpers::stringData(
    "LoginButton"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11LoginButtonE[] = {
...
Q_CONSTINIT const QMetaObject LoginButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11LoginButtonE.offsetsAndSizes,
    qt_meta_data_ZN11LoginButtonE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11LoginButtonE_t,
        // Q_OBJECT / Q_GADGET
...
void *LoginButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11LoginButtonE.stringdata0))
